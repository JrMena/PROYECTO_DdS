        ...
        public async Task<Venta> Registrar(Venta entidad)
        {
            ...
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    {
                        Producto produco_encontrado = _dbContext.Productos.Where(p => p.IdProducto == dv.IdProducto).First();

                        produco_encontrado.Stock = produco_encontrado.Stock - dv.Cantidad;
                        _dbContext.Productos.Update(produco_encontrado);
                    }
